...
\textbf{Our System (full swarm)} & \textbf{--} & \textbf{--} & \textbf{--} \\
\bottomrule
\end{tabular}
\label{tab:task_a}
\end{table}

\textit{Note: Full evaluation results are pending completion of the evaluation pipeline. Preliminary results on a 500-sample subset show RMSE of approximately 0.89 and ROUGE-L F1 of 0.18, suggesting meaningful improvement over the prompt-only baseline. Final numbers will be updated upon completion.}
